...
sales_model = joblib.load('lin_sales_detection.pkl')
...
def main():
    ...
    <h3 style="color:yellow; text-align:center;">Sales Prediction means predicting how much of product people will buy based on factors such as amount you spend to advertise your product, the segment of people you advertise for, or the platform you used for the advertisement. </h3>
    </div>
